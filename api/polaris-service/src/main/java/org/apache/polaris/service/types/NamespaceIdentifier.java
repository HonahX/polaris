...
@jakarta.annotation.Generated(
    ...
    date = "2025-03-05T19:55:03.816503-08:00[America/Los_Angeles]",
...
public class NamespaceIdentifier extends EntityIdentifier {
  ...
  public NamespaceIdentifier(
    ...
    this.namespace = Objects.requireNonNullElse(namespace, Namespace.of());
  }
  ...
  public static Builder builder(String catalog, Namespace namespace, TypeEnum type) {
  ...
  public static final class Builder {
    ...
    private Builder(String catalog, Namespace namespace, TypeEnum type) {
      this.catalog = catalog;
      this.namespace = Objects.requireNonNullElse(namespace, Namespace.of());
      this.type = type;
    }
