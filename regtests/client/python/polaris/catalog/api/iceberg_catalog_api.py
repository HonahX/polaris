...
class IcebergCatalogAPI:
    ...
    def _create_policy_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/{prefix}/namespaces/{namespace}/policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_policy_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/{prefix}/namespaces/{namespace}/policies/{policyName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_applicable_policies_on_table(
        self,
        prefix: Annotated[StrictStr, Field(description="An optional prefix in the path")],
        namespace: Annotated[StrictStr, Field(description="A namespace identifier as a single string. Multipart namespace parts should be separated by the unit separator (`0x1F`) byte.")],
        table: Annotated[StrictStr, Field(description="A table name")],
        ...
        _param = self._get_applicable_policies_on_table_serialize(
            prefix=prefix,
            namespace=namespace,
            table=table,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_applicable_policies_on_table_with_http_info(
        self,
        prefix: Annotated[StrictStr, Field(description="An optional prefix in the path")],
        namespace: Annotated[StrictStr, Field(description="A namespace identifier as a single string. Multipart namespace parts should be separated by the unit separator (`0x1F`) byte.")],
        table: Annotated[StrictStr, Field(description="A table name")],
    ...
    @validate_call
    def get_applicable_policies_on_table_without_preload_content(
        self,
        prefix: Annotated[StrictStr, Field(description="An optional prefix in the path")],
        namespace: Annotated[StrictStr, Field(description="A namespace identifier as a single string. Multipart namespace parts should be separated by the unit separator (`0x1F`) byte.")],
        table: Annotated[StrictStr, Field(description="A table name")],
    ...
    def _get_applicable_policies_on_table_serialize(
        self,
        prefix,
        namespace,
        table,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/{prefix}/namespaces/{namespace}/tables/{table}/policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def set_policy(
        ...
        namespace: Annotated[StrictStr, Field(description="A namespace identifier as a single string. Multipart namespace parts should be separated by the unit separator (`0x1F`) byte.")],
        policy_name: Annotated[str, Field(strict=True)],
        set_policy_request: SetPolicyRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param policy_name: (required)
        :type policy_name: str
        :param set_policy_request: (required)
        :type set_policy_request: SetPolicyRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._set_policy_serialize(
            prefix=prefix,
            namespace=namespace,
            policy_name=policy_name,
            set_policy_request=set_policy_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def set_policy_without_preload_content(
        self,
        prefix: Annotated[StrictStr, Field(description="An optional prefix in the path")],
        namespace: Annotated[StrictStr, Field(description="A namespace identifier as a single string. Multipart namespace parts should be separated by the unit separator (`0x1F`) byte.")],
        policy_name: Annotated[str, Field(strict=True)],
    ...
    def _set_policy_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if set_policy_request is not None:
            _body_params = set_policy_request
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/{prefix}/namespaces/{namespace}/policies/{policyName}/mappings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def unset_policy(
        ...
        namespace: Annotated[StrictStr, Field(description="A namespace identifier as a single string. Multipart namespace parts should be separated by the unit separator (`0x1F`) byte.")],
        policy_name: Annotated[str, Field(strict=True)],
        unset_policy_request: UnsetPolicyRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param policy_name: (required)
        :type policy_name: str
        :param unset_policy_request: (required)
        :type unset_policy_request: UnsetPolicyRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._unset_policy_serialize(
            prefix=prefix,
            namespace=namespace,
            policy_name=policy_name,
            unset_policy_request=unset_policy_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def unset_policy_with_http_info(
        self,
        prefix: Annotated[StrictStr, Field(description="An optional prefix in the path")],
        namespace: Annotated[StrictStr, Field(description="A namespace identifier as a single string. Multipart namespace parts should be separated by the unit separator (`0x1F`) byte.")],
        policy_name: Annotated[str, Field(strict=True)],
    ...
    @validate_call
    def unset_policy_without_preload_content(
        self,
        prefix: Annotated[StrictStr, Field(description="An optional prefix in the path")],
        namespace: Annotated[StrictStr, Field(description="A namespace identifier as a single string. Multipart namespace parts should be separated by the unit separator (`0x1F`) byte.")],
        policy_name: Annotated[str, Field(strict=True)],
    ...
    def _unset_policy_serialize(
        self,
        prefix,
        namespace,
        policy_name,
        unset_policy_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if unset_policy_request is not None:
            _body_params = unset_policy_request
