...
class SnapshotReference(BaseModel):
    ...
    max_ref_age_ms: Optional[StrictInt] = Field(default=None, alias="max-ref-age-ms")
    ...
    __properties: ClassVar[List[str]] = ["type", "snapshot-id", "max-ref-age-ms", "max-snapshot-age-ms", "min-snapshots-to-keep"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "max-ref-age-ms": obj.get("max-ref-age-ms"),
            "max-snapshot-age-ms": obj.get("max-snapshot-age-ms"),
            "min-snapshots-to-keep": obj.get("min-snapshots-to-keep")
        })
        return _obj
