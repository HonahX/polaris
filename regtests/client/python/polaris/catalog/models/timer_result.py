...
class TimerResult(BaseModel):
    ...
    TimerResult
    """ # noqa: E501
    time_unit: StrictStr = Field(alias="time-unit")
    count: StrictInt
    total_duration: StrictInt = Field(alias="total-duration")
    __properties: ClassVar[List[str]] = ["time-unit", "count", "total-duration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "time-unit": obj.get("time-unit"),
            "count": obj.get("count"),
            "total-duration": obj.get("total-duration")
        })
        return _obj
