...
class OAuthError(BaseModel):
    ...
    def error_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['invalid_request', 'invalid_client', 'invalid_grant', 'unauthorized_client', 'unsupported_grant_type', 'invalid_scope']):
            raise ValueError("must be one of enum values ('invalid_request', 'invalid_client', 'invalid_grant', 'unauthorized_client', 'unsupported_grant_type', 'invalid_scope')")
        return value
