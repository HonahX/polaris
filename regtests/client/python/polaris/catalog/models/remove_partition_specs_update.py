...
class RemovePartitionSpecsUpdate(BaseUpdate):
    ...
    spec_ids: List[StrictInt] = Field(alias="spec-ids")
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in set(['remove-partition-specs']):
            raise ValueError("must be one of enum values ('remove-partition-specs')")
        return value
