...
class StorageCredential(BaseModel):
    ...
    StorageCredential
    """ # noqa: E501
    prefix: StrictStr = Field(description="Indicates a storage location prefix where the credential is relevant. Clients should choose the most specific prefix (by selecting the longest prefix) if several credentials of the same type are available.")
    config: Dict[str, StrictStr]
    __properties: ClassVar[List[str]] = ["prefix", "config"]
