...
public class PolarisAuthorizerImpl implements PolarisAuthorizer {
  ...
  static {
    ...
    SUPER_PRIVILEGES.putAll(POLICY_CREATE, List.of(POLICY_CREATE, CATALOG_MANAGE_CONTENT));
    SUPER_PRIVILEGES.putAll(POLICY_READ, List.of(POLICY_READ, CATALOG_MANAGE_CONTENT));
    SUPER_PRIVILEGES.putAll(POLICY_DROP, List.of(POLICY_DROP, CATALOG_MANAGE_CONTENT));
    SUPER_PRIVILEGES.putAll(POLICY_WRITE, List.of(POLICY_WRITE, CATALOG_MANAGE_CONTENT));
    SUPER_PRIVILEGES.putAll(POLICY_LIST, List.of(POLICY_LIST, CATALOG_MANAGE_CONTENT));
    ...
    SUPER_PRIVILEGES.putAll(
        TABLE_LIKE_ATTACH_POLICY, List.of(TABLE_LIKE_ATTACH_POLICY, CATALOG_MANAGE_CONTENT));
    SUPER_PRIVILEGES.putAll(
    ...
    SUPER_PRIVILEGES.putAll(
        TABLE_LIKE_DETACH_POLICY, List.of(TABLE_LIKE_DETACH_POLICY, CATALOG_MANAGE_CONTENT));
  }
