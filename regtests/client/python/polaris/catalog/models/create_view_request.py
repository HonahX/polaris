...
class CreateViewRequest(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of view_version
        if self.view_version:
            _dict['view-version'] = self.view_version.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "view-version": ViewVersion.from_dict(obj["view-version"]) if obj.get("view-version") is not None else None,
