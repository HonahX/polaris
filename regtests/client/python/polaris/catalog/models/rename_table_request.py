...
class RenameTableRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "source": TableIdentifier.from_dict(obj["source"]) if obj.get("source") is not None else None,
            "destination": TableIdentifier.from_dict(obj["destination"]) if obj.get("destination") is not None else None
        })
        return _obj
