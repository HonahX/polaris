...
class SetDefaultSpecUpdate(BaseUpdate):
    ...
    """ # noqa: E501
    action: StrictStr
    spec_id: StrictInt = Field(description="Partition spec ID to set as the default, or -1 to set last added spec", alias="spec-id")
    __properties: ClassVar[List[str]] = ["action"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['set-default-spec']):
