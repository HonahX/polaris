...
class ListType(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr
    element_id: StrictInt = Field(alias="element-id")
    element: Type
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "element-id": obj.get("element-id"),
            "element": Type.from_dict(obj["element"]) if obj.get("element") is not None else None,
            "element-required": obj.get("element-required")
        })
        return _obj
