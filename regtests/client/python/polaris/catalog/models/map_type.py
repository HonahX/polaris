...
class MapType(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr
    key_id: StrictInt = Field(alias="key-id")
    key: Type
    value_id: StrictInt = Field(alias="value-id")
    value: Type
    value_required: StrictBool = Field(alias="value-required")
    __properties: ClassVar[List[str]] = ["type", "key-id", "key", "value-id", "value", "value-required"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "key-id": obj.get("key-id"),
            "key": Type.from_dict(obj["key"]) if obj.get("key") is not None else None,
            "value-id": obj.get("value-id"),
            "value": Type.from_dict(obj["value"]) if obj.get("value") is not None else None,
            "value-required": obj.get("value-required")
        })
        return _obj
