...
class Policy(BaseModel):
    ...
    """ # noqa: E501
    owner_entity: EntityIdentifier = Field(alias="owner-entity")
    ...
    __properties: ClassVar[List[str]] = ["owner-entity", "policy-type", "name", "description", "content", "version", "created-at-ms", "updated-at-ms"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of owner_entity
        if self.owner_entity:
            _dict['owner-entity'] = self.owner_entity.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "owner-entity": EntityIdentifier.from_dict(obj["owner-entity"]) if obj.get("owner-entity") is not None else None,
