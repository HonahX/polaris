...
class PartitionField(BaseModel):
    ...
    PartitionField
    """ # noqa: E501
    field_id: Optional[StrictInt] = Field(default=None, alias="field-id")
    source_id: StrictInt = Field(alias="source-id")
    name: StrictStr
    transform: StrictStr
    __properties: ClassVar[List[str]] = ["field-id", "source-id", "name", "transform"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "field-id": obj.get("field-id"),
            "source-id": obj.get("source-id"),
            "name": obj.get("name"),
