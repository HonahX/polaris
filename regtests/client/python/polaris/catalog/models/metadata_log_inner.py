...
class MetadataLogInner(BaseModel):
    """
    MetadataLogInner
    """ # noqa: E501
    metadata_file: StrictStr = Field(alias="metadata-file")
    timestamp_ms: StrictInt = Field(alias="timestamp-ms")
    __properties: ClassVar[List[str]] = ["metadata-file", "timestamp-ms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata-file": obj.get("metadata-file"),
