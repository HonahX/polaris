...
class SortOrder(BaseModel):
    ...
    SortOrder
    """ # noqa: E501
    order_id: StrictInt = Field(alias="order-id")
    fields: List[SortField]
    __properties: ClassVar[List[str]] = ["order-id", "fields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "order-id": obj.get("order-id"),
            "fields": [SortField.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None
        })
        return _obj
